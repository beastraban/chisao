...
from chisao import carry_tiger_seed, carry_tiger_rays, random_seed
...
def test_carry_tiger_seed_in_bounds():
    x0 = carry_tiger_seed(None, BOUNDS, n_rays=12, n_samples_per_ray=20,
                          use_gpu=False, seed=2)
...
def test_carry_tiger_seed_with_values():
    ...
    x0, f0 = carry_tiger_seed(f, BOUNDS, n_rays=8, n_samples_per_ray=10,
                              use_gpu=False, seed=3, return_values=True)
